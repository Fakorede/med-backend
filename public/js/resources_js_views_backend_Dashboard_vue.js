...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/ApexChart.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/ApexChart.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    var chart = new (apexcharts__WEBPACK_IMPORTED_MODULE_0___default())(document.querySelector(selector), _this.chartOption);
    setTimeout(function () {
      chart.render();
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/MorrisChart.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/MorrisChart.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    DonutChart: vue_morris__WEBPACK_IMPORTED_MODULE_0__.DonutChart,
    BarChart: vue_morris__WEBPACK_IMPORTED_MODULE_0__.BarChart,
    LineChart: vue_morris__WEBPACK_IMPORTED_MODULE_0__.LineChart,
    AreaChart: vue_morris__WEBPACK_IMPORTED_MODULE_0__.AreaChart
  },
  computed: {
    prettyFloorMinFollowers: function prettyFloorMinFollowers() {
      return this.prettyFloor(this.yMinMax['min']['followers']);
    },
    prettyCeilMaxFollowers: function prettyCeilMaxFollowers() {
      return this.prettyCeil(this.yMinMax['max']['followers']);
    },
    yMinMax: function yMinMax() {
      return this.minMax(this.data, 'followers');
    }
  },
  methods: {
    osColors: function osColors() {},
    minMax: function minMax(objects, field) {
      var result = {};
      return objects.reduce(function (valorAnterior, valorActual, indice) {
        ...
        valorActual[field] < result['min'][field] ? result['min'] = valorActual : ''; // eslint-disable-next-line no-unused-expressions

        valorActual[field] > result['max'][field] ? result['max'] = valorActual : '';
        return result;
      });
    },
    prettyFloor: function prettyFloor(number) {
    ...
    prettyCeil: function prettyCeil(number) {
      var l = Math.floor(Math.log10(Math.abs(number), 10)) - 1;
...
/* harmony import */ var _components_charts_MorrisChart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/charts/MorrisChart */ "./resources/js/components/charts/MorrisChart.vue");
/* harmony import */ var _components_charts_ApexChart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/charts/ApexChart */ "./resources/js/components/charts/ApexChart.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeCreate: function beforeCreate() {
    this.$options.components.OrderBody = __webpack_require__(/*! ../../views/backend/orders/OrderModal */ "./resources/js/views/backend/orders/OrderModal.vue").default;
  },
  components: {
    ApexChart: _components_charts_ApexChart__WEBPACK_IMPORTED_MODULE_3__.default,
    MorrisChart: _components_charts_MorrisChart__WEBPACK_IMPORTED_MODULE_2__.default
  },
  data: function data() {
    return {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              _context2.next = 4;
              return _this2.$broadcast();

            case 4:
              _context2.next = 6;
              return _this2.getPageStats();
  ...
  methods: {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 1;
                _context3.next = 4;
                return axios.get("/api/admin/orders/".concat(_this3.per_page, "?page=").concat(page), {
                  headers: {
    ...
    getPageStats: function getPageStats() {
      var _this4 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4() {
        var _yield$axios$get2, data, dateArr, distinctDateArr, created, processed, assigned, inTransit, delivered;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                _this4.pageStats = data; // morris chart

                _this4.item.bodyData[0].value = data.users.active_users;
                _this4.item.bodyData[1].value = data.users.inactive_users;
                _this4.item.bodyData[2].value = data.users.verified_users;
                _this4.item.bodyData[3].value = data.users.unverified_users; // bar chart

                dateArr = data.order_status_stats.map(function (arrItem) {
                  return arrItem.date;
                });
                distinctDateArr = _toConsumableArray(new Set(dateArr));
                _this4.chart1.xaxis.categories = distinctDateArr;
                created = [];
                processed = [];
                assigned = [];
                inTransit = [];
                ...
                _this4.chart1.xaxis.categories.forEach(function (date, index) {
                  var stats = _this4.pageStats.order_status_stats.filter(function (i) {
                    return i.date === date;
                  }); // console.log(date)
                  //console.log(stats)
                ...
                _this4.chart1.series[0].data = created;
                _this4.chart1.series[1].data = processed;
                _this4.chart1.series[2].data = assigned;
                _this4.chart1.series[3].data = inTransit;
                _this4.chart1.series[4].data = delivered;
                _this4.showMorrisChart = true;
                _this4.showBarChart = true;
                _context4.next = 32;
                break;
              ...
              case 28:
                ...
                if ((0,_config_response__WEBPACK_IMPORTED_MODULE_1__.is401)(_context4.t0)) {
                  _this4.$logOut();
                }
...
/***/ "./resources/js/components/charts/ApexChart.vue":
/*!******************************************************!*\
  !*** ./resources/js/components/charts/ApexChart.vue ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ApexChart_vue_vue_type_template_id_687d9866___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ApexChart.vue?vue&type=template&id=687d9866& */ "./resources/js/components/charts/ApexChart.vue?vue&type=template&id=687d9866&");
/* harmony import */ var _ApexChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ApexChart.vue?vue&type=script&lang=js& */ "./resources/js/components/charts/ApexChart.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _ApexChart_vue_vue_type_template_id_687d9866___WEBPACK_IMPORTED_MODULE_0__.render,
  _ApexChart_vue_vue_type_template_id_687d9866___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/charts/ApexChart.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/charts/MorrisChart.vue":
/*!********************************************************!*\
  !*** ./resources/js/components/charts/MorrisChart.vue ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _MorrisChart_vue_vue_type_template_id_57a68c3a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MorrisChart.vue?vue&type=template&id=57a68c3a& */ "./resources/js/components/charts/MorrisChart.vue?vue&type=template&id=57a68c3a&");
/* harmony import */ var _MorrisChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MorrisChart.vue?vue&type=script&lang=js& */ "./resources/js/components/charts/MorrisChart.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _MorrisChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _MorrisChart_vue_vue_type_template_id_57a68c3a___WEBPACK_IMPORTED_MODULE_0__.render,
  _MorrisChart_vue_vue_type_template_id_57a68c3a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/charts/MorrisChart.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/components/charts/ApexChart.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/js/components/charts/ApexChart.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ApexChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ApexChart.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/ApexChart.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ApexChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/charts/MorrisChart.vue?vue&type=script&lang=js&":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/charts/MorrisChart.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MorrisChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./MorrisChart.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/MorrisChart.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_MorrisChart_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 
...
/***/ "./resources/js/components/charts/ApexChart.vue?vue&type=template&id=687d9866&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/charts/ApexChart.vue?vue&type=template&id=687d9866& ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApexChart_vue_vue_type_template_id_687d9866___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApexChart_vue_vue_type_template_id_687d9866___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApexChart_vue_vue_type_template_id_687d9866___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ApexChart.vue?vue&type=template&id=687d9866& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/ApexChart.vue?vue&type=template&id=687d9866&");


/***/ }),

/***/ "./resources/js/components/charts/MorrisChart.vue?vue&type=template&id=57a68c3a&":
/*!***************************************************************************************!*\
  !*** ./resources/js/components/charts/MorrisChart.vue?vue&type=template&id=57a68c3a& ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_MorrisChart_vue_vue_type_template_id_57a68c3a___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_MorrisChart_vue_vue_type_template_id_57a68c3a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_MorrisChart_vue_vue_type_template_id_57a68c3a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./MorrisChart.vue?vue&type=template&id=57a68c3a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/MorrisChart.vue?vue&type=template&id=57a68c3a&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/ApexChart.vue?vue&type=template&id=687d9866&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/ApexChart.vue?vue&type=template&id=687d9866& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", { class: _vm.classname, attrs: { id: _vm.element } })
}
var staticRenderFns = []
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/MorrisChart.vue?vue&type=template&id=57a68c3a&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/charts/MorrisChart.vue?vue&type=template&id=57a68c3a& ***!
  \******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-lg-3 col-md-6" }, [
        _c(
          ...
          {
            staticClass:
              "card card-block card-stretch card-height position-relative overflow-hidden card-overlay-image"
          },
          [
            _c("div", { staticClass: "card-body" }, [
              _c(
                ...
                [
                  _c("div", { staticClass: "mm-cart-image text-primary" }, [
                    _c(
                      "svg",
                      {
                        staticClass: "svg-icon svg-blue mr-4",
                        attrs: {
                          id: "h-03",
                          width: "50",
                          height: "52",
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "mm-cart-text" }, [
                    _vm.pageStats.users
                      ? _c("h2", { staticClass: "font-weight-700" }, [
                          _vm._v(
                            "\n                                " +
                              _vm._s(_vm.pageStats.users.total_users) +
                              "\n                            "
                          )
                        ])
                      : _vm._e(),
          ...
          [
            _c("div", { staticClass: "card-body" }, [
              _c(
                ...
                [
                  _c("div", { staticClass: "mm-cart-image" }, [
                    _c(
                      "svg",
                      {
                        attrs: {
                      ...
                      [
                        ...
                        _c("path", {
                          attrs: {
                            d:
                              "M47.8684 5.61539C48.4293 5.61539 48.884 5.16068 48.884 4.59976C48.884 4.03885 48.4293 3.58414 47.8684 3.58414C47.3075 3.58414 46.8528 4.03885 46.8528 4.59976C46.8528 5.16068 47.3075 5.61539 47.8684 5.61539Z",
                            fill: "#4788FF"
                          }
                        })
                      ]
                  ...
                  _c("div", { staticClass: "mm-cart-text" }, [
                    ...
                    _vm.pageStats.users
                      ? _c("h2", {}, [
                          _c("b", [
                            _vm._v(_vm._s(_vm.pageStats.users.total_riders))
                          ])
                        ])
                      : _vm._e(),
                    _vm._v(" "),
            ...
            _vm._v(" "),
            _c("div", { staticClass: "overlay-image svg-primary" }, [
              _c(
                "svg",
                {
                  attrs: {
                ...
                [
                  _c("path", {
                    attrs: {
                      d:
                        "M108.5 68C82.4829 96.2795 31.0226 108.712 4.54413 112H259C262.2 112 263.333 108.667 263.5 107V6C263.5 1.6 259.167 0.166667 257 0H192.5C172.1 3.2 128 46.6667 108.5 68Z"
                    }
                  })
                ]
              )
      ...
      _c("div", { staticClass: "col-lg-3 col-md-6" }, [
        _c(
          ...
          [
                ...
                [
                    ...
                    _c(
                      ...
                      [
                        _c("path", {
                          attrs: {
                            d:
                              "M39.2031 23.3594C40.325 23.3594 41.2344 22.45 41.2344 21.3281C41.2344 20.2063 40.325 19.2969 39.2031 19.2969C38.0813 19.2969 37.1719 20.2063 37.1719 21.3281C37.1719 22.45 38.0813 23.3594 39.2031 23.3594Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        ...
                        _c("path", {
                          attrs: {
                            d:
                              "M39.7109 27.4219C32.9347 27.4219 27.4219 32.9347 27.4219 39.7109C27.4219 46.4872 32.9347 52 39.7109 52C46.4872 52 52 46.4872 52 39.7109C52 32.9347 46.4872 27.4219 39.7109 27.4219ZM39.7109 47.9375C35.1749 47.9375 31.4844 44.2471 31.4844 39.7109C31.4844 35.1747 35.1749 31.4844 39.7109 31.4844C44.247 31.4844 47.9375 35.1747 47.9375 39.7109C47.9375 44.2471 44.247 47.9375 39.7109 47.9375Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M42.6562 37.6797H41.7422V35.5469C41.7422 34.425 40.8328 33.5156 39.7109 33.5156C38.5891 33.5156 37.6797 34.425 37.6797 35.5469V39.7109C37.6797 40.8328 38.5891 41.7422 39.7109 41.7422H42.6562C43.7781 41.7422 44.6875 40.8328 44.6875 39.7109C44.6875 38.5891 43.7781 37.6797 42.6562 37.6797Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M30.3672 23.3594C31.489 23.3594 32.3984 22.45 32.3984 21.3281C32.3984 20.2063 31.489 19.2969 30.3672 19.2969C29.2454 19.2969 28.3359 20.2063 28.3359 21.3281C28.3359 22.45 29.2454 23.3594 30.3672 23.3594Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M21.5312 32.1953C22.6531 32.1953 23.5625 31.2859 23.5625 30.1641C23.5625 29.0422 22.6531 28.1328 21.5312 28.1328C20.4094 28.1328 19.5 29.0422 19.5 30.1641C19.5 31.2859 20.4094 32.1953 21.5312 32.1953Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M12.6953 23.3594C13.8171 23.3594 14.7266 22.45 14.7266 21.3281C14.7266 20.2063 13.8171 19.2969 12.6953 19.2969C11.5735 19.2969 10.6641 20.2063 10.6641 21.3281C10.6641 22.45 11.5735 23.3594 12.6953 23.3594Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M12.6953 32.1953C13.8171 32.1953 14.7266 31.2859 14.7266 30.1641C14.7266 29.0422 13.8171 28.1328 12.6953 28.1328C11.5735 28.1328 10.6641 29.0422 10.6641 30.1641C10.6641 31.2859 11.5735 32.1953 12.6953 32.1953Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M12.6953 41.0312C13.8171 41.0312 14.7266 40.1218 14.7266 39C14.7266 37.8782 13.8171 36.9688 12.6953 36.9688C11.5735 36.9688 10.6641 37.8782 10.6641 39C10.6641 40.1218 11.5735 41.0312 12.6953 41.0312Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M21.5312 41.0312C22.6531 41.0312 23.5625 40.1218 23.5625 39C23.5625 37.8782 22.6531 36.9688 21.5312 36.9688C20.4094 36.9688 19.5 37.8782 19.5 39C19.5 40.1218 20.4094 41.0312 21.5312 41.0312Z",
                            fill: "#f57e75"
                          }
                        }),
                        _vm._v(" "),
                        _c("path", {
                          attrs: {
                            d:
                              "M21.5312 23.3594C22.6531 23.3594 23.5625 22.45 23.5625 21.3281C23.5625 20.2063 22.6531 19.2969 21.5312 19.2969C20.4094 19.2969 19.5 20.2063 19.5 21.3281C19.5 22.45 20.4094 23.3594 21.5312 23.3594Z",
                            fill: "#f57e75"
                          }
                        })
                      ]
                  ...
                  _c("div", { staticClass: "mm-cart-text" }, [
                    _vm.pageStats.users
                      ? _c("h2", {}, [
                          _c("b", [
                            _vm._v(_vm._s(_vm.pageStats.orders.pending_orders))
                          ])
                        ])
                      : _vm._e(),
                    _vm._v(" "),
            ...
            _vm._v(" "),
            _c("div", { staticClass: "overlay-image svg-danger" }, [
              _c(
                "svg",
                {
                  attrs: {
          ...
          [
            _c("div", { staticClass: "card-body" }, [
              _c(
                ...
                [
                  _c("div", { staticClass: "mm-cart-image text-success" }, [
                    _c(
                      "svg",
                      {
                        staticClass: "svg-icon svg-success mr-4",
                        attrs: {
                          width: "50",
                          height: "52",
                          id: "h-02",
                  ...
                  _c("div", { staticClass: "mm-cart-text" }, [
                    _vm.pageStats.users
                      ? _c("h2", { staticClass: "font-weight-700" }, [
                          _vm._v(
                            "\n                                " +
                              _vm._s(_vm.pageStats.orders.completed_orders) +
                              "\n                            "
                          )
                        ])
                      : _vm._e(),
                    _vm._v(" "),
                    _c("p", { staticClass: "mb-0 text-success" }, [
            ...
            _c(
              ...
              [
                ...
                _c(
                  "div",
                  {
                    staticClass: "card-header-toolbar d-flex align-items-center"
                  },
                  [
                    _c(
                      "router-link",
                  ...
                  [
                    _c(
                      ...
                      [
                        _c("b-th", [_vm._v("#")]),
                        _vm._v(" "),
                        _c("b-th", [_vm._v("Total Amount(₦)")]),
                        _vm._v(" "),
                        _c("b-th", [_vm._v("Pickup Address")]),
                        _vm._v(" "),
                        _c("b-th", [_vm._v("Dropoff Address")]),
                        _vm._v(" "),
                        _c("b-th", [_vm._v("Order Type")]),
                        _vm._v(" "),
                        _c("b-th", [_vm._v("Order Status")]),
                        _vm._v(" "),
                      ...
                      _vm._l(_vm.orders, function(order, index) {
                        return _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("b-td", [_vm._v(_vm._s(order.pickup_address))]),
                            _vm._v(" "),
                            _c("b-td", [_vm._v(_vm._s(order.dropoff_address))]),
                            _vm._v(" "),
                            _c(
                              "b-td",
                              [
...
var staticRenderFns = [
    ...
    return _c(
      ...
      [
        _c("div", { staticClass: "header-title" }, [
          _c("h4", { staticClass: "card-title" }, [_vm._v("Users Stats")])
        ])
      ]
    )
  },
  function() {
    ...
    return _c(
      ...
      [
        _c("div", { staticClass: "header-title" }, [
          _c("h4", { staticClass: "card-title" }, [_vm._v("Orders Stats")])
        ])
      ]
    )
  },
  function() {
    ...
    return _c("div", { staticClass: "header-title" }, [
      _c("h4", { staticClass: "card-title" }, [_vm._v("Recent Orders")])
    ])
  }
]
render._withStripped = true
