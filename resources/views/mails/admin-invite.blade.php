        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div class="login100-form validate-form">
                    ...
                    @if ($role_id == 1) 
                        <div class="container-login100-form-btn">
                            You have been granted access to the Magic Express Delivery Admin Dashboard. Your login details are as follows:
                        </div>
                    @else
                        <div class="container-login100-form-btn">
                            You have been granted access to the Magic Express Delivery Rider App. Kindly download the app to access the Rider dashboard. Your login details are as follows:
                        </div>
                    @endif
                    <div class="container-login100-form-btn">
                        <p><span class="label-input100">Email: {{ $userEmail }}</span></p>
                    </div>
                    <div class="container-login100-form-btn">
