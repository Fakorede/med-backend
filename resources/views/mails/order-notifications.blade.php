        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div class="login100-form validate-form">
                    ...
                    <div class="container-login100-form-btn">
                      {{ $msgData }}. Please find the order summary below:
                    </div>

                    <div class="container-login100-form-btn">
                      <p><span class="label-input100">Order Id: {{ $order['id'] }}</span></p>
                    </div>
                    <div class="container-login100-form-btn">
                      <p><span class="label-input100">Total Amount : &#x20A6;{{ $order['total_price'] }}</span></p>
                    </div>
                    <div class="container-login100-form-btn">
                      <p><span class="label-input100">Pickup Address: {{ $order['pickup_address'] }}</span></p>
                    </div>
                    <div class="container-login100-form-btn">
                      <p><span class="label-input100">Dropoff Address: {{ $order['dropoff_address'] }}</span></p>
                    </div>
                    @if (!empty($order['delivery_note']))
                      <div class="container-login100-form-btn">
                        <p><span class="label-input100">Additional Note: {{ $order['delivery_note'] }}</span></p>
                      </div>
                    @endif

                    {{-- @if (auth()->user()->role_id == 1) --}}
                      <div class="container-login100-form-btn top">
                        <a href="{{ url('/login') }}" style="text-decoration: none;"`><button class="login100-form-btn">
